...
function parseSentinels(sentinels: string) {
...
export function getOptions() { // Get Options Method
...
// export const publisher = new Redis(getOptions())
// export const subscriber = new Redis(getOptions())
